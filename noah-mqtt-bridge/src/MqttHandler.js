...
class MqttHandler {
    ...
    async announceDevice() {
        ...
        for (const sensor of sensors) {
            ...
            this.client.publish(configTopic, JSON.stringify(configPayload), { retain: true, qos: 1 });
        }

        console.log("📢 MQTT Discovery: Alle 4 Sensoren erfolgreich an Home Assistant übermittelt.");
    }
